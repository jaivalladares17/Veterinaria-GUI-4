...
namespace Veterinaria {
	...
	/// <summary>
	/// Resumen de frmPacientes
	/// </summary>
	public ref class frmPacientes : public System::Windows::Forms::Form
	{
	public:
		frmPacientes(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(frmPacientes::typeid));
			...
			this->button4->Click += gcnew System::EventHandler(this, &frmPacientes::button4_Click);
			// 
			// button3
			// 
			this->button3->BackgroundImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"button3.BackgroundImage")));
			this->button3->BackgroundImageLayout = System::Windows::Forms::ImageLayout::None;
			this->button3->Location = System::Drawing::Point(282, 317);
			...
			this->button3->Click += gcnew System::EventHandler(this, &frmPacientes::button3_Click);
			// 
			// label1
			// 
			...
			this->label1->Text = L"Listado Pacientes";
			// 
			// listBox1
			// 
			...
			this->Name = L"frmPacientes";
			this->Text = L"Pacientes";
			this->Activated += gcnew System::EventHandler(this, &frmPacientes::OnActivated);
...
private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
	frmPacientesEdit^ frmPacienteEdit = gcnew frmPacientesEdit();
	frmPacienteEdit->Show();
}
private: System::Void OnActivated(System::Object^ sender, System::EventArgs^ e) {
	this->listBox1->Items->Clear();
	string ruta = "resources/archivos_dat/pacientes.dat";
	string linea;
	ifstream data(ruta);
	...
	while (!data.eof()) {
		...
		pac = new Paciente();
		pac->setEspecie(lista[0]);
		pac->setRaza(lista[1]);
		pac->setSexo(aux);
		pac->setPeso(stod(lista[3]));//Conversion de string a double con stod -> string to double
		pac->setColor(lista[4]);
		pac->setObservaciones(lista[5]);
		pac->setNombre(lista[6]);
		pac->setAlergias(lista[7]);
		pac->setEdad(stoi(lista[8]));//Conversion de string a int con stoi -> string to integer
		pac->setIdPaciente(lista[9]);
		pac->setUltimaVisita(lista[10]);
		this->listBox1->Items->Add(gcnew String(pac->generarCadena().c_str()));
	}
}
};
}
