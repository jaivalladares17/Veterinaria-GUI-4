...
namespace Veterinaria {
	...
	/// <summary>
	/// Resumen de frmVisitas
	/// </summary>
	public ref class frmVisitas : public System::Windows::Forms::Form
	{
	public:
		frmVisitas(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(frmVisitas::typeid));
			...
			this->button4->Location = System::Drawing::Point(498, 317);
			this->button4->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->button4->Name = L"button4";
			this->button4->Size = System::Drawing::Size(210, 66);
			this->button4->TabIndex = 11;
			this->button4->Text = L"Volver";
			this->button4->UseVisualStyleBackColor = true;
			this->button4->Click += gcnew System::EventHandler(this, &frmVisitas::button4_Click);
			// 
			// button3
			// 
			this->button3->BackgroundImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"button3.BackgroundImage")));
			this->button3->BackgroundImageLayout = System::Windows::Forms::ImageLayout::None;
			this->button3->Location = System::Drawing::Point(279, 317);
			this->button3->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(210, 66);
			this->button3->TabIndex = 10;
			this->button3->Text = L"Agregar";
			this->button3->UseVisualStyleBackColor = true;
			this->button3->Click += gcnew System::EventHandler(this, &frmVisitas::button3_Click);
			// 
			// label1
			// 
			...
			this->label1->Text = L"Listado Visitas";
			// 
			// listBox1
			// 
			...
			this->Name = L"frmVisitas";
			this->Text = L"Visitas";
			this->Activated += gcnew System::EventHandler(this, &frmVisitas::OnActivated);
...
private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
	frmVisitasEdit^ frmVisitaEdit = gcnew frmVisitasEdit();
	frmVisitaEdit->Show();
}
private: System::Void OnActivated(System::Object^ sender, System::EventArgs^ e) {
	this->listBox1->Items->Clear();
	string ruta = "resources/archivos_dat/visitas.dat";
	string linea;
	ifstream data(ruta);
	...
	while (!data.eof()) {
		...
		vis->setFecha(lista[0]);
		vis->setMedico(lista[1]);
		vis->setFactura(stoi(lista[2]));
		vis->setObservacion(lista[3]);
		vis->setTipo(lista[4]);
		vis->setPaciente(lista[5]);
		this->listBox1->Items->Add(gcnew String(vis->generarCadena().c_str()));
	}
}
};
}
